...
public final class ForecastMetrics {
    ...
    public lazy var mainDuration: TimeInterval? = mainRange?.duration
    ...
    public lazy var begInterval: TimeInterval? = mainTimestamps.first?.timeIntervalSinceReferenceDate
    ...
    public lazy var endMainDistance: TimeInterval? = mainDistances.last
    ...
    public lazy var combinedDistances: [TimeInterval] = mainDistances + extendedDistances.dropFirst()
    ...
    public lazy var combinedTimestamps: [Date] = mainTimestamps + extendedTimestamps.dropFirst()
}
