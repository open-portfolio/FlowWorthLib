...
class DateHelperTests: XCTestCase {
    func testDistances() throws {
        ...
        let expected: [TimeInterval] = [21600, 108_000]
        XCTAssertEqual(expected, actual)
    }

    func testGetStartOfDayGMT() throws {
        let rawDay = df.date(from: "2020-06-01T19:00:00Z")!
        let actual = getStartOfDay(for: rawDay, timeZone: TimeZone(identifier: "GMT")!)
    ...
    func testGetStartOfDayEST() throws {
        let rawDay = df.date(from: "2020-06-01T19:00:00Z")!
        let actual = getStartOfDay(for: rawDay, timeZone: TimeZone(identifier: "EST")!)
    ...
    func testGetStartOfDayMST1() throws {
        ...
        let actual = getStartOfDay(for: rawDay, timeZone: TimeZone(identifier: "MST")!)
