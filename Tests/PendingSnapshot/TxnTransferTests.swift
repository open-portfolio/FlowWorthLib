...
class TxnTransferTests: XCTestCase {
    var tz: TimeZone!
    ...
    var transferAdd: MTransaction!
    var transferSub: MTransaction!
    ...
    override func setUpWithError() throws {
        ...
        transferAdd = MTransaction(action: .transfer, transactedAt: timestamp2a, accountID: "A", securityID: "AGG", shareCount: 1, sharePrice: 20)
        transferSub = MTransaction(action: .transfer, transactedAt: timestamp2a, accountID: "A", securityID: "AGG", shareCount: -1, sharePrice: 20)
