...
class CashflowConsolidate3Tests: XCTestCase {
    ...
    func preConsolidateSetup() {
        ...
        md2 = MD(period: period2, startValue: position1.marketValue, endValue: position2.marketValue, cashflowMap: cfm2)!
        md3 = MD(period: period3, startValue: position2.marketValue, endValue: position3.marketValue, cashflowMap: cfm3)!
    ...
    func getMD() -> MD {
        ...
        return MD(period: DateInterval(start: timestamp1A, end: timestamp7),
                  startValue: position1.marketValue,
                  endValue: position3.marketValue,
